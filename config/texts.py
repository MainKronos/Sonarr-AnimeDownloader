...
ANIME_INEXISTENT_LOG = "❌ La 𝘴𝘵𝘢𝘨𝘪𝘰𝘯𝘦 {season} della 𝘴𝘦𝘳𝘪𝘦 '{anime}' non esiste nella 𝗧𝗮𝗯𝗲𝗹𝗹𝗮 𝗗𝗶 𝗖𝗼𝗻𝘃𝗲𝗿𝘀𝗶𝗼𝗻𝗲."
TABLE_INEXISTENT_LOG = "⚠️ Il file table.json non esiste, quindi verrà creato."
ANIME_RESEARCH_LOG = "🔎 Ricerca anime '{anime}' per l'episodio S{season}E{episode}."
EPISODE_RESEARCH_LOG = "🔎 Ricerca degli episodi per '{anime}'."
...
AUTOMATIC_LINK_SEARCH_LOG = "⚠️ Ricerca automatica link di AnimeWorld."
NO_RESULT_LOG = "⛔ Nessun risultato trovato."
LINK_FOUND_LOG = """✳️ Risultato trovato, verrà utilizzato nella prossima ricerca: 
- {anime} ({link})."""
